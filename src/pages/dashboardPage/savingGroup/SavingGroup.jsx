...
const SavingGroup = () => {
  ...
  const filteredOutcome = groupData?.group_member_outCome_data?.filter(
    (item) => {
      const userMatch =
        ...
        <>
            ...
            <div className="form-control w-full max-w-xs">
              ...
              >
                ...
                {[
                  ...
                  const userName = groupData.group_member_outCome_data.find(
          ...
          <div className="card bg-neutral text-yellow-300 shadow-md">
            <div className="card-body">
              <h2 className="card-title">💰 Member Incomes</h2>
              <ul className="divide-y divide-gray-700">
                {groupData.group_member_income_data.map((member) => (
                  ...
                  >
                    ...
                    <span>
                      {parseInt(member.member_income).toLocaleString()} MMK
                    </span>
                  </li>
                ))}
              </ul>
                    ...
                    {filteredOutcome.length > 0 ? (
                      filteredOutcome.map((item, i) => (
                        <tr key={i}>
                          ...
                          <td>{parseInt(item.amount).toLocaleString()} MMK</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
